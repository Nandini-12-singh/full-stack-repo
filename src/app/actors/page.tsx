...
export default function ActorsPage() {
	...
	const { data: popularActors, isLoading: isLoadingPopular } =
		usePopularActors();
						...
						<motion.div
							...
							<motion.p
								...
								<span className='text-purple-500 dark:text-purple-400 font-semibold bg-gradient-to-r from-purple-500 to-pink-500 dark:from-purple-400 dark:to-pink-400 bg-clip-text text-transparent'>
									Find your favorite performers and their incredible
									filmography.
								</span>
							</motion.p>
							...
							<div>
								<motion.div
										...
										<div className='flex items-center gap-4'>
											...
											<div>
												...
												<p className='text-gray-600 dark:text-gray-400'>
													...
													{new Date().getFullYear() - selectedActor.birthYear}{" "}
													years old
												</p>
											</div>
										</div>
									...
									<div className='flex flex-wrap gap-2'>
										{selectedActor.genres.map((genre) => (
											<span
												key={genre}
								...
								{isLoadingActorMovies ? (
								  ...
								  actorMovies.Search.length > 0 ? (
									...
									<>
										<EmptyState
											query={`movies by ${selectedActor.name}`}
											onSuggestionClick={handleSuggestionClick}
										/>
									</>
								)}
